...
namespace Pucene\Bundle\ElasticBundle\DependencyInjection\CompilerPass;
...
{
    const TAG_NAME = 'pucene_elastic.query_builder';
    const POOL_SERVICE_ID = 'pucene_elastic.query_builder.pool';
